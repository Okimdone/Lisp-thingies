...
(defun add-voiture (ref proprietaire couleur puissance carburant matricule capacite annee-achat annee-en-cours)
...
;;; in one go
(defun add-voiture-and-personne (refvoiture proprietaire couleur puissance carburant matricule capacite annee-achat annee-en-cours
                                date-naissance pere mere nationalite poids liste-enfants)
    (add-voiture refvoiture proprietaire couleur puissance carburant matricule capacite annee-achat annee-en-cours)
    (add-personne proprietaire date-naissance pere mere nationalite poids liste-enfants refvoiture)
    refvoiture)
...
;;; Définisser une autre fonction "nouvelle-annee(instVoiture, nouvAnnee)": elle m-a-j l'année en cours
;;; de la voiture instVoiture et lui applique ensuite le test de vieille
